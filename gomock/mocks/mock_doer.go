...
// Source: github.com/EricYT/go-examples/gomock/doer (interfaces: Doer)
...
// DoOther mocks base method
func (m *MockDoer) DoOther() error {
	ret := m.ctrl.Call(m, "DoOther")
	ret0, _ := ret[0].(error)
	return ret0
}

// DoOther indicates an expected call of DoOther
func (mr *MockDoerMockRecorder) DoOther() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DoOther", reflect.TypeOf((*MockDoer)(nil).DoOther))
}
